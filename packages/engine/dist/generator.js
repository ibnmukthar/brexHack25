...
class WorkflowGenerator {
    ...
    generateFreightForwardingWorkflow(id, intent) {
        const steps = [
            {
    ...
    generateWarehousingWorkflow(id, intent) {
        const steps = [
            {
    ...
    generateCustomsWorkflow(id, intent) {
        const steps = [
            {
    ...
    generateConsolidationWorkflow(id, intent) {
        const steps = [
            {
    ...
    generatePortManagementWorkflow(id, intent) {
        const steps = [
            {
    ...
    generateComplianceWorkflow(id, intent) {
        const steps = [
            {
    ...
    generateCrossDockingWorkflow(id, intent) {
        const steps = [
            {
